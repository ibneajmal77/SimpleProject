//-----------------------------------------------------------------------
// <copyright file="UnitOfWork.cs" client="ManagementSystem">
...
namespace Equatorial.PLR.Infrastructure.Repository.UnitOfWork
{
    ...
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public IRepository<T> Repository<T>() where T : class
        {
            ...
            {
                Type repositoryType = typeof(Equatorial.PLR.Infrastructure.Repository.GenericRepository.Repository<>);
        ...
        {
            var changedEntriesCopy = this.context.ChangeTracker.Entries()
